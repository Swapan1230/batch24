...
public class CharaterStreamExample {
	private static String inputFile = "/Users/jrout/git/batch24/CoreJava/src/jrout/tutorial/corejava/condition/IfElseExample.mp3";
	private static String outputFile = "Batch24.mp3";

	public static void main(String args[]) throws IOException {
//		charStreamDirect();
		charStreamUsingBuffer();
	}
	// Use Character Stream to a read a binary file and copy to another binary file.
